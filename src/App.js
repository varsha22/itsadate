...
export default function App() {
  ...
  //   [participants]
  // );
  // const renderSubscriptionBadge = (participant) =>{
  ...
  const joinCall = useCallback(() => {
    ...
    // Example: subscribe to audio tracks and stage video tracks for a particular session_id
callObject.updateParticipant('b95ec8cc-499f-480c-f68c-3373c8553693', {
  setSubscribedTracks: { audio: true, video: 'staged', screenVideo: false },
});
